...
@interface SkinCareTableViewController ()

@end

@implementation SkinCareTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text=[self.skinCareArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (newCell.accessoryType == UITableViewCellAccessoryNone) {
        ...
        [self.itemsToBePassed addObject:[self.skinCareArray objectAtIndex:indexPath.row]];
    }else {
        newCell.accessoryType = UITableViewCellAccessoryNone;
        [_itemsToBePassed removeObject:[self.skinCareArray objectAtIndex:indexPath.row]];
    }
