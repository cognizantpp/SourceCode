//
//  PersonTaughtTableViewController.m
//  EducationView
//
...
@implementation PersonTaughtTableViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    ...
    self.personTaughtArray = [NSArray arrayWithObjects:@"Egg", @"Apple", @"Msngo", @"Burger", @"Ham and Egg Sandwich", @"Sandwich", @"Pizza",@"Other", nil];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return [self.personTaughtArray count];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text=[self.personTaughtArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (newCell.accessoryType == UITableViewCellAccessoryNone) {
        ...
        [self.itemsToBePassed addObject:[self.personTaughtArray objectAtIndex:indexPath.row]];
    }else {
        newCell.accessoryType = UITableViewCellAccessoryNone;
        [_itemsToBePassed removeObject:[self.personTaughtArray objectAtIndex:indexPath.row]];
    }
