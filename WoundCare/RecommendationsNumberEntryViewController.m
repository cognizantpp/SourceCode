...
@interface RecommendationsNumberEntryViewController ()

@end

@implementation RecommendationsNumberEntryViewController
...
- (IBAction)numberClicked:(UIButton*)sender {
    ...
    if([_entryData length] >6){
        ...
        [self.delegate updateRecommendationsEntryNumber:_entryData];
    }
}
- (IBAction)btnGoClicked:(id)sender {
    [self.delegate OkRecommendationsClicked];
}
