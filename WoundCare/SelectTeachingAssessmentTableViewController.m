//
//  SelectTeachingAssessmentTableViewController.m
//  EducationView
//
...
@implementation SelectTeachingAssessmentTableViewController
...
- (void)viewDidLoad {
    ...
    self.teachingAssessmentArray = [NSArray arrayWithObjects:@"Egg", @"Apple", @"Msngo", @"Burger", @"Ham and Egg Sandwich", @"Sandwich", @"Pizza",@"Other", nil];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return [self.teachingAssessmentArray count];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text=[self.teachingAssessmentArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (newCell.accessoryType == UITableViewCellAccessoryNone) {
        ...
        [self.itemsToBePassed addObject:[self.teachingAssessmentArray objectAtIndex:indexPath.row]];
    }else {
        newCell.accessoryType = UITableViewCellAccessoryNone;
        [_itemsToBePassed removeObject:[self.teachingAssessmentArray objectAtIndex:indexPath.row]];
    }
