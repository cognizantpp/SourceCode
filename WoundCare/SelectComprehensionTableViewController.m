//
//  SelectComprehensionTableViewController.m
//  EducationView
//
...
@implementation SelectComprehensionTableViewController
...
- (void)viewDidLoad {
    ...
    self.comprehensionArray = [NSArray arrayWithObjects:@"Egg", @"Apple", @"Msngo", @"Burger", @"Ham and Egg Sandwich", @"Sandwich", @"Pizza", nil];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return [self.comprehensionArray count];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text=[self.comprehensionArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (newCell.accessoryType == UITableViewCellAccessoryNone) {
        ...
        [self.itemsToBePassed addObject:[self.comprehensionArray objectAtIndex:indexPath.row]];
    }else {
        newCell.accessoryType = UITableViewCellAccessoryNone;
        [_itemsToBePassed removeObject:[self.comprehensionArray objectAtIndex:indexPath.row]];
    }
